...
//		String sub_mch_id = product.getAppAuthToken();
...
//			packageParams.put("sub_mch_id", sub_mch_id); //TODO 子商户 传入参数
...
//
//	@Override
//	public String weixinTradePay(Product product) {
//		String sub_mch_id = product.getAppAuthToken();
//		String authCode = product.getAuthCode();
//		logger.info("订单号：{}生成微信支付码",product.getOutTradeNo());
//		String  message = Constants.SUCCESS;
//		try {
//			// 账号信息
...
//			ConfigUtil.commonParams(packageParams);
//			packageParams.put("sub_mch_id", sub_mch_id); //TODO 子商户 传入参数
//			packageParams.put("auth_code",authCode); // 用户付款码
//			packageParams.put("body", product.getBody());// 商品描述
//			packageParams.put("out_trade_no", product.getOutTradeNo());// 商户订单号
//			String totalFee = product.getTotalFee();
//			totalFee =  CommonUtil.subZeroAndDot(totalFee);
